...
aime24 = LightevalTaskConfig(
    ...
    hf_repo="/lnt/workspace/pengyingzhe.py/code/lmms-eval/data/aime_2024",
    hf_subset="default",
...
aime25 = LightevalTaskConfig(
    ...
    suite=["custom"],
    prompt_function=aime_prompt_fn,
    hf_repo="/lnt/workspace/pengyingzhe.py/code/lmms-eval/data/aime_2025",
    hf_subset="default",
    hf_avail_splits=["train"],
    evaluation_splits=["train"],
    few_shots_split=None,
...
math_500 = LightevalTaskConfig(
    ...
    hf_repo="/lnt/workspace/pengyingzhe.py/code/lmms-eval/data/MATH-500",
    hf_subset="default",
...
gpqa_diamond = LightevalTaskConfig(
    ...
    hf_repo="/lnt/workspace/pengyingzhe.py/code/lmms-eval/data/gpqa",
